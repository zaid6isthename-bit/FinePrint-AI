...
function AutonomousDriver() {
  ...
  useEffect(() => {
    ...
    function firePointer(nx: number, ny: number) {
      ...
      // Convert normalized [0,1] to R3F pointer coordinates [-1,1]
      // Actually, PointerEvent clientX/clientY are handled by R3F/Three via raycasting.
      // The React Bits FluidGlass uses state.pointer which is mapped from standard events.
