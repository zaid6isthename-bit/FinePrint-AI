                ...
                {status === "completed" ? (
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="w-8 h-8 rounded-full bg-gradient-to-tr from-gold to-primary shadow-[0_0_20px_rgba(var(--gold-rgb),0.5)] border border-black/20 dark:border-white/20"
                        />
                    </motion.div>
                )}
            </AnimatePresence>
