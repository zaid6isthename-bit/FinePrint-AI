    ...
    return (
        <nav className="hidden md:flex fixed top-0 left-0 right-0 z-[100] h-[68px] items-center justify-between px-6 sm:px-10 bg-background/80 backdrop-blur-xl border-b border-black/5 dark:border-white/5">
            ...
            <div className="flex items-center gap-4">
                {user ? (
                    <div className="flex items-center gap-4">
                        <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-[4px] bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10">
                            {user.image ? (
                    ...
                    <div className="flex items-center gap-3">
                        <ModeToggle />
                        <Link href="/login">
                            <Button variant="ghost" size="sm" className="text-[10px] font-mono tracking-[0.12em] uppercase text-muted-foreground hover:text-gold border border-transparent hover:border-black/5 dark:border-white/5 px-4 h-9 rounded-[4px]">
                                Sign In
                            </Button>
                        </Link>
                        <Link href="/signup">
