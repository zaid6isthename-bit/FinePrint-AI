...
export default function UploadPage() {
    ...
    return (
        <main className="min-h-screen pt-[40px] md:pt-[100px] pb-24 px-0 md:px-6 flex flex-col items-center relative overflow-hidden bg-background">
            {/* Ambient Orbs */}
            ...
            <AnimatePresence mode="wait">
                {step === "upload" ? (
                    <div key="upload-wrapper" className="w-full max-w-2xl z-10 px-6">
                        {/* Mobile UI */}
                        ...
                        ${isDragActive ? "border-gold bg-gold/5 scale-[1.01] shadow-2xl shadow-gold/10" : "border-black/10 dark:border-white/10 hover:border-gold/40 hover:bg-black/[0.01] dark:bg-white/[0.01]"}
                                        ...
                                        <AnimatePresence mode="wait">
                                            {file ? (
                                                ...
                                                <motion.div
                                                    ...
                                                    className="flex flex-col items-center gap-6"
                                                >
                                                    <div className="w-16 h-16 rounded-[4px] bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 group-hover:bg-gold/10 group-hover:border-gold/30 transition-all duration-700 flex items-center justify-center">
                            ...
                            {step === "completed" ? (
                                ...
                                >
                                    ...
                                    <motion.div
                                        ...
                                        className="h-px w-48 bg-black/10 dark:bg-white/10 rounded-full overflow-hidden"
                                    >
                                        <motion.div
                                            animate={{ x: ["-100%", "100%"] }}
