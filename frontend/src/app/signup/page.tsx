...
import { Loader2, Mail, Lock, ArrowRight, UserPlus, Eye, EyeOff } from "lucide-react";
                ...
                <GlassEffect className="p-8 sm:p-10 rounded-3xl">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="pl-12 pr-12 h-12 bg-transparent border border-black/10 dark:border-white/10 text-foreground rounded-sm focus:ring-gold/50 placeholder:text-muted-foreground/40 font-mono text-xs"
                                        required
                                    />
                                    <button
                                        type="button"
                        ...
                        <div className="mt-10 pt-8 border-t border-black/5 dark:border-white/5 text-center">
                            <p className="text-[9px] font-mono tracking-[0.1em] text-muted-foreground/40 uppercase">
                                Already activated?{" "}
                                <Link href="/login" className="text-gold hover:text-foreground transition-all inline-flex items-center group ml-1">
                                    Sign In
