...
import { BarristerLogo } from "@/components/Logo";

export default function Home() {
  return (
    <>
      {/* Mobile Content (Phone/Tablet) */}
      <div className="md:hidden">
        <MobileHome />
      </div>

      {/* Desktop Content */}
      <main className="hidden md:flex min-h-screen flex-col items-center justify-center p-6 sm:pt-32 sm:pb-24 sm:px-24 relative overflow-hidden bg-transparent">
        ...
        >
          ...
          >
            <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-gold/5 border border-gold/20 backdrop-blur-md">
              <span className="text-[9px] font-mono font-bold tracking-[0.35em] text-gold uppercase">Proprietary Legal Intelligence</span>
            </div>
          </motion.div>
          ...
          <p className="text-lg sm:text-xl text-muted-foreground mb-12 max-w-lg mx-auto leading-relaxed font-light">
            Barrister AI reads every clause of your contracts with the precision of a senior counsel - detecting hidden risks, quantifying exposure, and translating legalese before you sign.
          </p>
            ...
            <Link href="/upload" className="w-full sm:w-auto">
              ...
              >
                ...
                >
                  ...
                  <motion.div
                    className="absolute inset-0 bg-black/5 dark:bg-black/5 dark:bg-white/5"
                    initial={{ x: "-100%" }}
                    whileHover={{ x: "100%" }}
